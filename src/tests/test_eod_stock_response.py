...
from src.IntelligentStockMarketAPI.models.eod_stock_response import EODStockResponse  # noqa: E501
from src.IntelligentStockMarketAPI.rest import ApiException

class TestEODStockResponse(unittest.TestCase):
    """EODStockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test EODStockResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = src.IntelligentStockMarketAPI.models.eod_stock_response.EODStockResponse()  # noqa: E501
        if include_optional :
            return EODStockResponse(
                message = '0', 
                payload = src.IntelligentStockMarketAPI.models.eod_stock.EODStock(
                    adjusted_close = 56, 
                    close = 56, 
                    code = '0', 
