...
from src.IntelligentStockMarketAPI.models.technicals import Technicals  # noqa: E501
from src.IntelligentStockMarketAPI.rest import ApiException

class TestTechnicals(unittest.TestCase):
    """Technicals unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = src.IntelligentStockMarketAPI.models.technicals.Technicals()  # noqa: E501
        if include_optional :
            return Technicals(
                beta = 1.337, 
