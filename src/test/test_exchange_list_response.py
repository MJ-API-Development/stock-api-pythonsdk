...
from openapi_client.models.exchange_list_response import ExchangeListResponse  # noqa: E501
...
class TestExchangeListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.exchange_list_response.ExchangeListResponse()  # noqa: E501
        if include_optional :
            return ExchangeListResponse(
                message = '0', 
                payload = openapi_client.models.exchange.Exchange(
                    code = '0', 
                    country = '0', 
                    currency_symbol = '0', 
                    exchange_id = '0', 
