...
from openapi_client.models.eod_stock_response import EODStockResponse  # noqa: E501
...
class TestEODStockResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.eod_stock_response.EODStockResponse()  # noqa: E501
        if include_optional :
            return EODStockResponse(
                message = '0', 
                payload = openapi_client.models.eod_stock.EODStock(
                    adjusted_close = 56, 
                    close = 56, 
                    code = '0', 
