...
from openapi_client.models.stock_list_response import StockListResponse  # noqa: E501
from openapi_client.rest import ApiException

class TestStockListResponse(unittest.TestCase):
    """StockListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test StockListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.stock_list_response.StockListResponse()  # noqa: E501
        if include_optional :
            return StockListResponse(
                message = '0', 
                payload = openapi_client.models.stock.Stock(
                    code = '0', 
                    currency = '0', 
                    exchange_code = '0', 
                    exchange_id = '0', 
    ...
    def testStockListResponse(self):
        """Test StockListResponse"""
