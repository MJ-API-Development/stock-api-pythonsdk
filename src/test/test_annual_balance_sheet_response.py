...
from openapi_client.models.annual_balance_sheet_response import AnnualBalanceSheetResponse  # noqa: E501
...
class TestAnnualBalanceSheetResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.annual_balance_sheet_response.AnnualBalanceSheetResponse()  # noqa: E501
        if include_optional :
            return AnnualBalanceSheetResponse(
                message = '0', 
                payload = openapi_client.models.annual_balance_sheet.AnnualBalanceSheet(
