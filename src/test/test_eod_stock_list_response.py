...
from openapi_client.models.eod_stock_list_response import EODStockListResponse  # noqa: E501
...
class TestEODStockListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.eod_stock_list_response.EODStockListResponse()  # noqa: E501
        if include_optional :
            return EODStockListResponse(
                message = '0', 
                payload = [
                    openapi_client.models.eod_stock.EODStock(
                        adjusted_close = 56, 
                        close = 56, 
                        code = '0', 
