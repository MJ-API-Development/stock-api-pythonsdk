...
class AnnualBalanceSheetResponse(object):
    ...
    def __init__(self, message=None, payload=None, status=None, local_vars_configuration=None):  # noqa: E501
        """AnnualBalanceSheetResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this AnnualBalanceSheetResponse.  # noqa: E501

        message explaining the response  # noqa: E501

        :return: The message of this AnnualBalanceSheetResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this AnnualBalanceSheetResponse.

        message explaining the response  # noqa: E501

        :param message: The message of this AnnualBalanceSheetResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def payload(self):
        """Gets the payload of this AnnualBalanceSheetResponse.  # noqa: E501


        :return: The payload of this AnnualBalanceSheetResponse.  # noqa: E501
    ...
    def payload(self, payload):
        """Sets the payload of this AnnualBalanceSheetResponse.


        :param payload: The payload of this AnnualBalanceSheetResponse.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this AnnualBalanceSheetResponse.  # noqa: E501

        if status is True data was found and payload contains valid data  # noqa: E501

        :return: The status of this AnnualBalanceSheetResponse.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AnnualBalanceSheetResponse.

        if status is True data was found and payload contains valid data  # noqa: E501

        :param status: The status of this AnnualBalanceSheetResponse.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnnualBalanceSheetResponse):
            return False
